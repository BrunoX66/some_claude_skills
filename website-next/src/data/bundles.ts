...
export const bundles: Bundle[] = [
  {
    ...
    difficulty: 'advanced',
    skills: [
      { id: 'ai-engineer', role: 'Builds RAG pipelines and LLM applications' },
      { id: 'prompt-engineer', role: 'Crafts effective prompts and prompt chains' },
      { id: 'mcp-creator', role: 'Creates Model Context Protocol servers' },
      { id: 'agent-creator', role: 'Designs and builds AI agents' },
      { id: 'clip-aware-embeddings', role: 'Implements semantic image-text matching', optional: true },
    ],
    installCommand: 'claude \"/install @some-claude-skills/ai-development-stack\"',
    estimatedCost: { tokens: 100000, usd: 1.5 },
    useCases: [
    ...
    tags: ['ai', 'llm', 'rag', 'mcp', 'agents', 'featured'],
    heroImage: '/img/bundles/ai-development-stack-hero.png',
    featured: true,
    relatedBundles: ['documentation-powerhouse', 'startup-mvp-kit'],
  },
  {
    ...
    skills: [
      { id: 'security-auditor', role: 'Scans for OWASP vulnerabilities and security anti-patterns' },
      { id: 'refactoring-surgeon', role: 'Identifies code smells and suggests clean refactors' },
      { id: 'test-automation-expert', role: 'Reviews test coverage and suggests missing test cases' },
      { id: 'technical-writer', role: 'Checks documentation quality and suggests improvements' },
      { id: 'vitest-testing-patterns', role: 'Applies modern testing patterns for JavaScript/TypeScript', optional: true },
    ],
    installCommand: 'claude \"/install @some-claude-skills/code-review-suite\"',
    estimatedCost: { tokens: 50000, usd: 0.75 },
    useCases: [
    ...
    tags: ['code-review', 'security', 'testing', 'teams', 'featured'],
    heroImage: '/img/bundles/code-review-suite-hero.png',
    featured: true,
    relatedBundles: ['startup-mvp-kit', 'documentation-powerhouse'],
  },
  {
    ...
    difficulty: 'beginner',
    skills: [
      { id: 'technical-writer', role: 'Writes clear, structured technical documentation' },
      { id: 'diagramming-expert', role: 'Creates architecture diagrams, flowcharts, and ERDs' },
      { id: 'seo-visibility-expert', role: 'Optimizes docs for search engine discoverability' },
      { id: 'research-analyst', role: 'Researches topics for comprehensive coverage', optional: true },
    ],
    installCommand: 'claude \"/install @some-claude-skills/documentation-powerhouse\"',
    estimatedCost: { tokens: 40000, usd: 0.6 },
    useCases: [
    ...
    tags: ['documentation', 'technical-writing', 'api-docs', 'diagrams', 'featured'],
    heroImage: '/img/bundles/documentation-powerhouse-hero.png',
    featured: true,
    relatedBundles: ['code-review-suite', 'ai-development-stack'],
  },
  {
    ...
    difficulty: 'beginner',
    skills: [
      { id: 'career-biographer', role: 'Documents your career journey and achievements' },
      { id: 'cv-creator', role: 'Creates ATS-optimized resumes and portfolios' },
      { id: 'job-application-optimizer', role: 'Tailors applications to specific job postings' },
      { id: 'digital-estate-planner', role: 'Organizes digital life and important accounts' },
      { id: 'personal-finance-coach', role: 'Helps with budgeting and financial planning', optional: true },
    ],
    installCommand: 'claude \"/install @some-claude-skills/personal-growth-bundle\"',
    estimatedCost: { tokens: 30000, usd: 0.45 },
    useCases: [
    ...
    tags: ['career', 'productivity', 'beginner', 'personal'],
  ...
  },
  {
    ...
    difficulty: 'intermediate',
    skills: [
      { id: 'web-design-expert', role: 'Creates responsive UI components and landing pages' },
      { id: 'api-architect', role: 'Designs REST/GraphQL APIs with proper authentication' },
      { id: 'drizzle-migrations', role: 'Manages database schema with type-safe migrations' },
      { id: 'vercel-deployment', role: 'Deploys with CI/CD, preview URLs, and custom domains' },
      { id: 'modern-auth-2026', role: 'Implements secure OAuth, JWT, and session management', optional: true },
    ],
    installCommand: 'claude \"/install @some-claude-skills/startup-mvp-kit\"',
    estimatedCost: { tokens: 75000, usd: 1.13 },
    useCases: [
    ...
    tags: ['startup', 'web-development', 'full-stack', 'deployment', 'featured'],
    heroImage: '/img/bundles/startup-mvp-kit-hero.png',
    featured: true,
    relatedBundles: ['code-review-suite', 'documentation-powerhouse'],
  },
];
